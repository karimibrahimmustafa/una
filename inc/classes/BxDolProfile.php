...
class BxDolProfile extends BxDolFactory implements iBxDolProfile
{
    ...
    protected $_aProfile;
    protected $_oQuery;
    protected $_aProfileType;
    protected $_typeofAccount;
    /**
     * Constructor
     */
    public function  getId_number(){
        return $this->_iProfileID-1;
    }
    protected function __construct ($iProfileId)
    {
        ...
        $this->_aProfileType = 1;// since constructor is protected $iProfileId is always valid
    ...
    /**
     * Get content type associated with the profile
     */
    ...
    return BXDolProfileQuery::getInstance()->getTypeOfAccount();
